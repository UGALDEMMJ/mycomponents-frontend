...
export const SidebarAdmin = () => {
  ...
  return (
    <div className='p-3 text-white font-space-mono'>
      ...
      <div className='mt-auto border-t pt-4 border-zinc-700'>
        <Link to={"/admin"} className='flex items-center gap-3 p-2 w-full rounded-md hover:bg-gradient-to-br hover:from-black hover:to-cyan-400 transition-colors text-white '>Admin</Link>
      </div>
