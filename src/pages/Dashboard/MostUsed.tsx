...
import { Component, getMostUsed, updateComponentClicks } from "../../api/components";
                    ...
                    <>
                        ...
                        <div className="flex flex-col items-center gap-4 text-white">
                            {components.map((comp) => (
                                <div
                                    key={comp.id}
                                    className="border rounded-xl border-cyan-500 flex flex-col max-w-full w-full bg-black/80 shadow-lg"
                                >
